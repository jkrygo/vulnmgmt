...
<h2>Description</h2>
The purpose of this lab is to install [Nessus Vulnerability Scanner](https://www.tenable.com/products/nessus/nessus-essentials) and analyze the differences in vulnerabilities between machines with up-to-date software and machines with deprecated software. I will perform a non-credentialed scan, a credentialed scan, another credentialed scan after installing deprecated software, and a final credentialed scan after critical vulnerabilities have been remediated.
